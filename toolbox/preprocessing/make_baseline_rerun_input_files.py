...
input_config_dir = os.path.join(str(INPUT_DIR),"v1-rerun-baseline")
template_config_filepath = os.path.join(input_config_dir,"rerun_template.yaml")
# test_output_path = os.path.join(input_config_dir,"test_input.yaml")
# shutil.copy(template_config_filepath,test_output_path)
# with open(test_output_path,"r") as f:
#     file_contents = f.read()
# file_contents = file_contents.replace("<atb_year>","2030")
# file_contents = file_contents.replace('<finance_case_filename>','"profast_config_v1_onshore_2030.yaml"')
...
elec_cost_version_and_desc = {"v1_GS":"baseline","v1_custom":"expensive","v1_pathway":"cheap"}
...
elec_capex_cases_config = {"v1_GS":dict(zip(cost_years,baseline_elec_cost_files)),
...
config_notes_list_filepath = os.path.join(run_notes_dir,"finance_reruns_input_filenames-baseline.md")
